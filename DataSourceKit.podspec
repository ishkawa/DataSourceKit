#
#  Be sure to run `pod spec lint DataSourceKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ehlen, David"
  # s.authors            = { "Ehlen, David" => "david.ehlen@dm.de" }
  # s.social_media_url   = "http://twitter.com/Ehlen, David"
